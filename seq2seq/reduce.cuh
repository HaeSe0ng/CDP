...
namespace detail
{
  ...
  struct MinMaxReductionOps
  {
    ...
    static C10_DEVICE arg_t project(arg_t arg) { return arg; }
  ...
  struct ArgReductionOps : public MinMaxReductionOps<comp_t>
  {
    ...
    static C10_DEVICE index_t project(arg_t arg) { return arg.second; }
  };
...
C10_HOST_DEVICE static void reduce_fraction(size_t &numerator,
                                            size_t &denominator)
{
